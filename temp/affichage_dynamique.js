...
function afficher_BD_random() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    infos_card_BD.textContent =
      objet_album.titre + ", prix : " + objet_album.prix;
